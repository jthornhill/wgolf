...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference("Preference.count") do
      post preferences_url, params: { preference: { time_zone: @preference.time_zone, user_id: @preference.user_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { time_zone: @preference.time_zone, user_id: @preference.user_id } }
