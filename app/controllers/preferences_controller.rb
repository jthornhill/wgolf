class PreferencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @preference.save
        format.html { redirect_to root_url, notice: 'Preference was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @preference.update(preference_params)
        format.html { redirect_to root_url, notice: 'Preference was successfully updated.' }
  ...
  def preference_params
    params.require(:preference).permit(:time_zone, :user_id)
  end
end
